        ...
        <div className="intro">
            <div className="intro__left">
                <div className='intro__left-wrapper'>
                    ...
                    I am excited to share my story of how after several months of hard working, intensive learning and inexhaustible motivation I can call myself a web developer.
                    </p>
